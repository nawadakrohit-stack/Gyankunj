...
// --- ADMISSION FORM BACKEND INTEGRATION ---
document.querySelector('.enquiry-form form').addEventListener('submit', async (e) => {
    e.preventDefault(); // Page refresh hone se rokne ke liye

        // Form se values nikalna
            const nameInput = document.querySelector('.enquiry-form input[type="text"]');
                const mobileInput = document.querySelector('.enquiry-form input[type="tel"]');
                    const courseSelect = document.querySelector('.enquiry-form select');
                        ...
                        const name = nameInput.value;
                            const mobile = mobileInput.value;
                                const course = courseSelect.value;
                                    ...
                                    try {
                                            // Hamare chal rahe backend port 5000 ko hit karna
                                                                                                                                                                                ...
                                                                                                                                                                                nameInput.value = '';
                                                                                                                                                                                            mobileInput.value = '';
                                                                                                                                                                                                        courseSelect.selectedIndex = 0;
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            alert("❌ Server ne bola kuch gadbad hai!");
                                                                                                                                                                                                                                    }
                                                                                                                                                                                                                                        } catch (error) {
                                                                                                                                                                                                                                                console.error("Error:", error);
                                                                                                                                                                                                                                                        alert("⚠️ Backend server chalu nahi hai ya connection me dikkat hai!");
                                                                                                                                                                                                                                                            }
                                                                                                                                                                                                                                                            });
